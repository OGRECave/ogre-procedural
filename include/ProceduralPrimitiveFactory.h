...
class ProceduralPrimitiveFactory
{
	...
	public:
		...
		Ogre::MeshPtr createCone(const Ogre::String& name, float radius, float height, int numSegHeight, int numSegBase, float uTile, float vTile);
		...
		Ogre::MeshPtr createCylinder(const Ogre::String& name, float radius, float height, bool capped, int numSegHeight, int numSegBase, float uTile, float vTile);
		Ogre::MeshPtr createTube(const Ogre::String& name, float innerRadius, float outerRadius, float height, int numSegHeight, int numSegBase, float uTile, float vTile);
		Ogre::MeshPtr createTorus(const Ogre::String& name, float radius, float sectionRadius, int numSegCircle, int numSegSection, float uTile, float vTile);
		//TODO : implement
		...
		//TODO : implement
		Ogre::MeshPtr createChamferBox(const Ogre::String& name, float sizeX, float sizeY, float sizeZ, float sizeChamfer, int numSegX, int numSegY, int numSegZ, float uTile, float vTile);
};