...
pushd %BUILD_DIR%
rem call CMake
cmake -DOGRE_HOME:PATH=E:\Prog\Builds\Ogre18_vs10_unity\sdk -DPROCEDURAL_INSTALL_SAMPLES_SOURCE:BOOL=TRUE -DPROCEDURAL_INSTALL_DOCS:BOOL=TRUE -G%GENERATOR% ..\..
...
pushd sdk
cmake -DOGRE_HOME:PATH=E:\Prog\Builds\Ogre18_vs10_unity\sdk -G%GENERATOR% .\
if errorlevel 1 goto cmakeerror
