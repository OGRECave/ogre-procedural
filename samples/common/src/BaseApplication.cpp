...
//-------------------------------------------------------------------------------------
BaseApplication::BaseApplication(const Ogre::String &helpDescription)
...
{
  v1::Entity* ent2 = mGraphicsSystem->getSceneManager()->createEntity(meshName, Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
                                                                      Ogre::SCENE_DYNAMIC);
	SceneNode* sn = mGraphicsSystem->getSceneManager()->getRootSceneNode()->createChildSceneNode();
